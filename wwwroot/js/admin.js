    ...
    switch (name) {
        ...
        case 'delete-from-product':
            return document.getElementById(
                'delete-images-from-products-checkbox'
            ).checked
            break
    ...
    confirmAction(
        ...
        () => {
            ...
            fetch(`${window.location.origin}/api/products/${productId}`, {
                method: 'delete',
                headers: {
                    'delete-images': retrieveSetting('delete-product-images'),
                },
            })
                .then((data) => data.text())
                .then((data) => {
    ...
    confirmAction(
        ...
        () => {
            ...
            fetch(`${window.location.origin}/api/images`, {
                ...
                headers: {
                    id: id,
                    'delete-from-product': retrieveSetting(
                        'delete-from-product'
                    ),
                },
            })
    ...
    function handleFailure(error) {
        switch (mode) {
            default:
                ...
                infoSnackbar.text =
                    '<i style="color: #FF5252;">Error</i>: ' + error
